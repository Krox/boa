...
void LLVMSetInstrParamAlignment(LLVMValueRef Instr, uint index, uint align_);
...
LLVMValueRef LLVMBuildBinOp     (LLVMBuilderRef, LLVMOpcode Op, LLVMValueRef LHS, LLVMValueRef RHS, const char* Name);
...
/* Casts */
LLVMValueRef LLVMBuildTrunc(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char* Name);	// int <-> int
...
LLVMValueRef LLVMBuildFPToUI(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char* Name);	// int <-> float
...
LLVMValueRef LLVMBuildFPTrunc(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char* Name);	// float <-> float
LLVMValueRef LLVMBuildFPExt(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char* Name);

LLVMValueRef LLVMBuildPtrToInt(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char* Name);	// ptr <-> int
...
LLVMValueRef LLVMBuildPointerCast(LLVMBuilderRef, LLVMValueRef Val, LLVMTypeRef DestTy, const char* Name);	// ptr <-> ptr
